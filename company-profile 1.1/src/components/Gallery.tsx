...
export default function Gallery() {
    const images = [
        { src: img1, title: "PAMA BBSO Dukung Konservasi Bekantan" },
        { src: img2, title: "Keberagaman" },
        { src: img3, title: "Peresmian Tempat Uji Kompetensi SMK" },
        { src: img4, title: "Persada Collaboration" },
        { src: img5, title: "Mudik Bersama" },
        { src: img6, title: "Lulus Pelatihan" },
    ];
        ...
        <section id="gallery" className="bg-gray-900 text-white py-20 px-6 md:px-12 lg:px-24">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                {images.map((item, index) => (
                    ...
                    >
                        ...
                        />
                        <div className="absolute inset-0 bg-black bg-opacity-30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center text-white text-lg font-semibold text-center px-4">
                            {item.title}
                        </div>
                    </div>
                ))}
            ...
            {selectedImage && (
                ...
                >
                    ...
                    />
                    <button
                        className="absolute top-6 right-6 bg-white text-gray-900 px-4 py-2 rounded-lg font-semibold hover:bg-gray-300 transition"
                        onClick={() => setSelectedImage(null)}
                    >
                        Close
                    </button>
